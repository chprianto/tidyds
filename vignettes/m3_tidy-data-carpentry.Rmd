---
title: "Intro tidy data and data carpentry"
...
`table1` termasuk "Tidy data" karena terdapat variable, observation dan value 

```{r}
table2
```

`table2` tidak termasuk "Tidy data" karena ...dalam kolom type terdapat dua nilai yang bisa dijadikan kolom baru
...
`table4a` tidak termasuk "Tidy data" karena value/nilai pada kolom 1999 dan 2000 tidak menunjukan nilai yang mewakili apa
